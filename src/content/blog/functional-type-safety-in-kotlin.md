...
description: Declare lambda signatures with this simple trick!
tags:
  - android
cover: ../../assets/content/posts/attachments/functional_type_safety.jpg
coverAlt: Functional type safety in kotlin with functional interfaces
---

![functional type safety chad](../../assets/content/posts/attachments/functional_type_safety_chad.png)
...
5. Advancing to Receiver Functions and DSLs
...
Ah yes, quite the _[first class citizen treatment](/peek/lies/)_ . **BUT!!** I hear you exclaim in bold, all caps. **It can be quite clunky to write out function signatures `Int.(Int) -> Int`**.
