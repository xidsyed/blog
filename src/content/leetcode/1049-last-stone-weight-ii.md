...
description: "Solution to the problem: 1049. Last Stone Weight II"
tags:
  - dsadeck
  - dp
---
...
Pattern: [Pattern DP Subset Sum](/pattern-dp-subset-sum/)
Related: [416. Partition Equal Subset Sum](/leetcode/416-partition-equal-subset-sum/)
...
Essentially it boils down to an [Pattern DP Subset Sum](/pattern-dp-subset-sum/) problem.
