...
description: "Solution to the problem: 919 · Meeting Rooms II"
tags:
  - dsadeck
  - intervals
---
...
Related: [986. Interval List Intersections](/leetcode/986-interval-list-intersections/)
...
- Similiar to the [Line Sweep Algorithm](/line-sweep-algorithm/) you extract and sort points from an interval, every time an interval starts, increment `sim` (which is the count of simultaneous intervals), and every time an interval ends `p.isStart == false` decrement `sim--`
