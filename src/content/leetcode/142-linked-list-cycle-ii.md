...
description: "Solution to the problem: 142. Linked List Cycle II"
tags:
  - dsadeck
  - arrays
---
...
Pattern: [Pattern Fast and Slow Pointer}](/pattern-fast-and-slow-pointer/)
...
continued from [GFG Detect Loop](/leetcode/gfg-detect-loop/#why-fast-pointer-skips-1-specifically)
...
- Length travelled by `F` = `2 (x+y)` (cuz it was moving _2x as fast_ as `S`)
