...
description: "Solution to the problem: 229. Majority Element II"
tags:
  - dsadeck
  - arrays
---
...
Checkout the concept in [169. Majority Element](/leetcode/169-majority-element/) first. Here the only difference is, there can only be 2 majority elements max. Why?

`n=9`, for an element to be a majority element it has to occupy, atleast `n/3 +1` spaces _(more than n/3 times_ so `4 spaces`
