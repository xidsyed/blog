...
description: "Solution to the problem: GFG Split Circular Linked List into Two Halves"
tags:
  - dsadeck
  - linkedlist
---
...
- Now just find [876. Middle of the Linked List](/leetcode/876-middle-of-the-linked-list/) and slow will point to floor of mid, and `fast` will point to `tail` if LL is Odd, if its even, `while(fast.next != head) fast = fast.next` should give u the tail
