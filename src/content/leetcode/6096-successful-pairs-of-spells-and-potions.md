...
description: "Solution to the problem: 6096. Successful Pairs of Spells and Potions"
tags:
  - dsadeck
  - arrays
  - binarysearch
...
- Element in Potions array will be smaller than `success/spell`
  - Now all you have to do is find the [Ceil](/binary-search/#floor-ceil) of that number
